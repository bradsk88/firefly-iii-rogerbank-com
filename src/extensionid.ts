...
// Banks are not often consisten in the way they display deposits and
// withdrawals. Particularly with credit cards, a negative value might mean
// a charge on the card (a.k.a a withdrawal) or it might mean a payment to
// the card (a.k.a a deposit). Set this true if negative means "withdrawal"
// or false if negative means "deposit".
export const negativeMeansWithdrawal = false;